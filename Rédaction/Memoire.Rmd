...
# Chapitre 1. Faire l'économie des familles recomposées
...
## Le calcul du niveau de vie à l'épreuve des configuration familiales recomposées

> *Je ne sais pas si cette sous partie ira à la fin du I ou au début du II, et ça pourrait meme aller en fin du II ou en début du III. il s'agit de dire que le niveau de vie est mal estimé dans les familles recomposées, ce qui est pour plusieurs raisons et que cela à plusieurs conséquences. Donc probablement si ca reste ici c'est pour des raisons de type d'interrogation méthodologique (ici on est pls sur des questions de statistiques et de mesure*) et dans ce cas on le pose comme ressort problématique, avec un II qui cherche a fournir une explication et un III qui cherche à expliciter les conséquences. , mais ça peut aller au début du II parce que ce qui suit explique cela, ça peut aller à la fin du II parce que c'ets la conséquence de ce qu'on esxplique dans le II

#### Les inégalités de revenus secondaires

#### Indicateur au fondement des dispositifs de redistribution
