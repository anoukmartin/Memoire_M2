...
```{r}
indiv <- readRDS("Data_output/individus.Rds")
```
...
Le graphique ci-dessous illustre la situation familiale des enfants,
décrite par les liens légaux et la cohabitation. Il distingue les
familles traditionnelles, monoparentales et recomposées.
...
7 enfants vivants en ménage ordinaire sur 10 vivent avec leurs deux
parents, et eventuellement, les autres enfants issus de leur union,
c'est-à-dire dans une famille traditionnelle. C'est de loin la situation
la plus courante. Les enfants vivants en familles monoparentale
...
sont deux fois moins nombreux que ceux vivant en famille monoparentale :
ceux-ci représentent 10,6% des enfants vivants en ménage ordinaire, soit
envions 1 sur 10. On retrouve ici des chiffres proches mais néanmoins
différents de ceux produit par @algava2020 à partir des données du
...
recomposées. Cela s'explique peut-être par les différences de définition
du couple et du ménage entre le recensement et les enquêtes ménages
[@toulemon2011], mais cela tient aussi peut-être à la limite d'age que
