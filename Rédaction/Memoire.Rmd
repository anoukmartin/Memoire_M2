...
Un couple est composé de deux personnes de 15 ans ou plus, habitant le
même logement et déclarant actuellement être en couple, quel que soit
leur état matrimonial légal (qu'ils soient donc mariés ou non).
...
célibataire, qui n'est pas en couple avec une personne de son ménage (au
sens des enquêtes auprès des ménages), ayant un parent (père ou mère)
dans son ménage, et n'étant pas lui-même parent (père ou mère) d'une
personne de son ménage.

\end{encadre}
```
Ainsi, la statitique publique met également l'accent sur la cohabitation
entre enfant et parent pour classer les ménages en fonction de leur
structure familiale. Cependant, elle ne s'y limite pas : les ménages
composés d'individus vivant avec leurs grands-parents et sans leur
parents sont par exemple classés dans les lénages complexes. C'est bien
l'existance d'un lien de filiation direct ou non qui détermine aussi ces
catégorisations.
...
ne fait ainsi pas référence au droit civil de filiation. Sans qu'elle se
suffise à elle-même, la parenté légale a cependant acquis une grande
centralité dans la définition ordinaire du père et de la mère
[@weber2013], de sorte que l'on peut raisonnablement considérer que
l'enquête saisit bien des liens établits par le droit. On obsreve aussi
que liens entre beaux-parents et beaux-enfants sont renseignées
(modalités 31 et 32). Cependant en cherchant les questions à l'origine
du code de ces variables, on comprend que ces modalités correspondent en
réalité des relations avec la belle-famille, c'est-à-dire les parents du
conjoint. L'absence de cette modalité témoigne de l'impensé que
constitue les relations entre un adulte et les enfants de son conjoint,
qui n'as pas moins d'existance légale que celles qui concernent la
belle-famille, dans la statistique publique. Quoiqu'il en soi, ces
variables permettent de saisir les liens de filiation légale. En
articulant ceux-ci aux lien conjugaux, il est possible d'identifier les
ménages dans lesquels un couple vit avec au moins un enfant qui n'est
pas légalement issu de leur union.
...
déclarations de leurs parents. Ainsi, nous concentrerons les analyses
...
ainsi `r nrow(enfantsMenage)` enfants au sens du TCM.
...
Le graphique ci-dessous illustre la situation familiale des enfants. Il
distingue les familles traditonelles, monoparentales et recomposées.
...
g +
  ...
  labs(caption = paste0("Source : ", infosBDF$nom, ", ", 
                        ...
                        insert_line_breaks(paste0(
                          ...
                          infosBDF$champ, 
                          " (hors ménages complexes) (n = ", 
                          nrow(dat), ")")
                          ), 
                        insert_line_breaks("\nLecture : 70% des enfants résidant en ménage ordinaires en 2017 vivaient en famille traditionelle."))) +
  theme_memoire() +
...
7 enfants vivants en ménage ordinaire sur 10 vivent dans une famille
traditionnelle, c'est-à-dire avec leurs deux parents. C'est de loin la
situation la plus courante. Les enfants vivant en familles monoparentale
représentent 19,4% de ceux vivants en ménage ordinaires, soit un peu
moins d'un enfants sur cinq. Les enfants vivants en famille recomposées
sont deux fois moins nombreux : ceux-ci représentent 10,6% des enfants
vivants en ménage ordinaire, soit envions 1 sur 10. On retrouve ici des
chiffres proches mais néanmoins différents de ceux produit par
@algava2020 à partir des données du recensement en 2018 qui comptaient
68% d'enfants vivants en familles traditionnelles, 21% en familles
monoparentales et 11% en familles recomposées. Cela s'explique peut-être
par les différences de définition du couple et du ménage entre le
recensement et les enquêtes ménages [@toulemon2011], mais cela tient
aussi peut-être à la limite d'age que nous avons ici définit pour les
enfants (25 ans) ce qui de fait, réduit le nombre de famille considérés
comme monoparentales.

Parmis les enfants vivants en familles recomposées, 27,3% sont issus de
l'union actuelle et vivent donc, comme ceux vivant en famille
traditionnelles, avec leurs deux parents.

Dans 83,5% cas, ces enfants résident avec leur mères. Les enfants
vivants avec leur mères célibataires représentent ainsi 16,2% des
enfants vivants en ménage ordinaires.

Le plus souvent l'autre parent existe et réside ailleurs.

Dans le cas des familles monoparentales, 14,5% des enfants résident
uniquement avec leur mère, tandis que 1,8% vivent avec leur père.

Les familles recomposées, où les enfants vivent avec l'un de leurs
parents et un beau-parent, montrent une diversité plus importante. 3,2%
des enfants vivent avec leur mère dans une famille recomposée, tandis
que 2,1% résident avec leur père. Il est intéressant de noter que 2,9%
des enfants dans des familles recomposées ont un autre parent décédé ou
inconnu.

En résumé, la majorité des enfants en France en 2017 vivent dans une
famille traditionnelle, suivie par ceux vivant dans des familles
monoparentales, principalement avec leur mère. Les familles recomposées
représentent une part moindre, mais non négligeable, de la population
enfantine, avec une répartition presque égale entre ceux vivant avec
leur mère et ceux vivant avec leur père.

On retrouve ici les chiffres du recensement de 2018 [@algava2020].
[Peut-être commenter un peu plus les différences de situations survant
que l'autre parent est décédé ou inconnu ou non]
...
déterminer celles des parents. Pour chaque enfant, nous avons récupéré,
lorsqu'ils était disponible, l'identifiant du père, de la mère, du
conjoint ou de la conjointe du père et du conjoint ou de la conjoint de
la mère. En comparant, l'identifiant du conjoints et conjointe de chaque
parent à celui de l'autre parent, nous avons pu déterminer pour chaque
enfant, l'identifiant des parents et des beaux-parents lorsqu'ils
existaient. Ainsi pour chaque individu de l'enquête nous avons pu
déterminé s'il était parent, s'il était beau parent, le nombre d'enfants
et de beaux-enfants (dans le ménage et hors domicile) ainsi que leur âge
moyen. Dans un soucis de cohérence et d'intelligibilité des résultats
nous n'avons conservé ces informations que pour les adultes ou en couple
avec un adulte. Nous avons définit la catégorie des adultes en miroir
des enfants, comme l'ensemble des individus qui ne sont pas enfants au
...
A partir des variables ainsi produites sur les parents, nous avons pu
identifier les personnes en couple. Bien que les couples vivant dans des
logement séparés soient plus fréquent lors de la formation d'union
secondaires et que l'absence de cohabitation fasse préelnnement partie
d'un procèdsus de "reconjugalisation" [\@; @régnier-loilier2019], nous
avons choisit de considérer comme couple uniquement les conjoint
cohabitant. Ce choix tient d'une part à la volonté de notre part
d'articuler l'absence de parenté légale à la possibilité de construction
d'une parenté pratique, ce qui, le plus souvent, se fait dans le partage
du quotidien. D'autre part, cela tient à des ocnsidération pratique
puisque les personnes vivants dans des logements éparés ne sont pas
considérés comme faisant partie d'un même ménage. En ce sens, y compris
lorsqu'il s'agit d'un conjoint, l'enquête n'interrogent pas leur
caractéristiques et leurs pratiques économiques. Enfin les effectifs
concernés dans l'enquête par la conjugalité non-cohabitante sont très
faibles. Pour classer les différents ménages en fonction de leur
configuration familiale, seuls les couples dont au moins un des deux
membres était personne de référence du ménage ont été retenus. En
reprenant la typologie de ménage de l'Insee (Personne seule sans enfant,
personne seule avec enfant, couple sans enfants, couple avec enfants et
ménages complexes) nous avons distingué, parmi les couples avec enfants,
ceux dont au moins ceux dont au moins un des membres était beau-père ou
belle-mère d'enfants vivants dans le ménage de ceux ou l'ensemble des
enfants du ménage étaient issus de l'union conjugale actuelle. Par
soucis de fluidité, nous parlerons ainsi souvent de familles recomposées
pour désigner ces ménages présentant une configuration familiale
recomposée. Pour autant, il faut garder à l'esprit que la recomposition
familiale est une phénomène qui déborde largement l'échelle du ménage.
Ces familles recomposées sont ainsi au nombre de 634 dans l'enquête.
